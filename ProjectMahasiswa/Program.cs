...
namespace ProjectMahasiswa
{
    class Program
    {
        ...
        static void TambahMahasiswa()
        {
            ...
            mahasiswa.Jenis_Kelamin = (JenisKelamin == "L" || JenisKelamin == "P") ? "Laki Laki" : "Perempuan";
        ...
        static void TampilMahasiswa()
        {
            ...
            {
                Console.WriteLine("{0}.\t{1}\t{2} \t{3}\t{4}", no, mahasiswa.NIM, mahasiswa.Nama, mahasiswa.Jenis_Kelamin, mahasiswa.IPK);
                no++;
            }
